...
Write-Host "Checking for updates (Animal_AiCity2.0)..." -ForegroundColor Cyan

$apiUrl = "https://api.github.com/repos/GRILLYje/Animal_AiCity2.0_Public/releases/latest"
...
$folderPath = "$env:TEMP\Animal_AiCity2.0"
...
Write-Host "Launching Animal_AiCity2.0..." -ForegroundColor Green
